            ...
            <div class="well profile">
                 <div class="col-sm-12">
                     <div class="col-xs-12 col-sm-8">
                         <h2>${user.username}</h2>
                         <p><strong><spring:message code="full_name"/>:
                                </strong>${user.fio!=null && !user.fio.equals("") ? user.fio : "--"}
                         </p>
                         <p><strong><spring:message code="from"/>:
                                </strong>${user.city!=null && !user.city.equals("") ? user.city : "--"}
                         </p>
                         <p><strong><spring:message code="email"/>:
                                </strong>${user.email!=null && !user.email.equals("") ? user.email : "--"}
                         </p>
                         <p><strong><spring:message code="telephone_number"/>:
                                </strong>${user.telephone!=null && !user.telephone.equals("") ? user.telephone : "--"}
                         </p>
                         <p><strong><spring:message code="sex"/>:
                                </strong>${user.sex!=null && !user.sex.equals("") ? user.sex : "--"}
                         </p>
                         <p><strong><spring:message code="date_of_birth"/>:
                                </strong>${user.dateOfBirth!=null && !user.dateOfBirth.equals("") ? user.dateOfBirth : "--"}
                         </p>
                     </div>
