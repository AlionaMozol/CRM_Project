...
public class SqlService {
    ...
    public static final String SQL_GET_CATEGORIES_N_ATTRIBUTES =   "SQL_GET_CATEGORIES_N_ATTRIBUTES";
    public static final String SQL_SELECT_TYPE_ID_BY_CATEGORY_AND_SUPERCATEGORY =
                                                                   "SQL_SELECT_TYPE_ID_BY_CATEGORY_AND_SUPERCATEGORY";
    ...
    public static final String SQL_GET_OBJ_ID_BY_OBJ_TYPE_ID =     "SQL_GET_OBJ_ID_BY_OBJ_TYPE_ID";
